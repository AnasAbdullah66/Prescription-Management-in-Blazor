...
namespace PrescrioptionManagement.Server.Migrations
{
    ...
    [Migration("20230303231458_Prescription")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrescrioptionManagement.Shared.MedicalTest", b =>
                {
                    b.Property<int>("MedicalTestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrescrioptionManagement.Shared.Patient", b =>
                {
                    b.Property<int>("PatientId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrescrioptionManagement.Server.Models.TestEntry", b =>
                {
                    b.HasOne("PrescrioptionManagement.Shared.MedicalTest", "MedicalTest")
                        .WithMany("TestEntries")
                        .HasForeignKey("MedicalTestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PrescrioptionManagement.Shared.Patient", "Patient")
                        .WithMany("TestEntries")
